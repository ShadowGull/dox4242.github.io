...
(function(window, document, $, undefined) {
  ...
  function save() {
    ...
    this.hasSpell = function(save, spell) {
            ...
            if(_spell.name == "Catalyst") {
                    return this.challenge_active(save,991) || this.challenge_active(save,1063) || this.upgrade_owned(save,940) || (save.reincarnation >= 130 && this.upgrade_owned(save,142019) && save.elitePrestigeFaction == 14)
            }
            if(_spell.name == "Gem Grinder" && this.upgrade_owned(save, 183)) return true;
            if(_spell.name == "Holy Light" && this.upgrade_owned(save, 39)) return true;
            if(_spell.name == "Blood Frenzy" && this.upgrade_owned(save, 103)) return true;
    ...
    this.blankSave = function() {
      ...
      for (var i = 1; i <= this.lengths.buildings; i++) {
        save.buildings[i] = {
          ...
          q: 0, t: 0, r: 0,
          m: 0, e: 0,
          um0: 0, um1: 0, um2: 0, ue0: 0, ue1: 0, ue2: 0
        };
      }
  ...
  function assoc() {
    ...
    this.trophyIDs = [
      ...
      {id: 111207, name: 'Mana Squall'},
      {id: 111208, name: 'Mana Storm'},
      {id: 111209, name: 'Mana Wave'},
      {id: 111210, name: 'Mana River'},
      {id: 111211, name: 'Mana Lake'},
      {id: 111212, name: 'Mana Sea'},
      {id: 111213, name: 'Mana Ocean'},
      {id: 111214, name: 'Mana Spring'},
      {id: 111215, name: 'Mana Falls'},
    ...
    this.upgradeIDs = [
      ...
      {id: 402501, name: 'Temporal Flux 2'},
      {id: 402502, name: 'Temporal Flux 3'},
      {id: 402503, name: 'Temporal Flux 4'},
      {id: 402504, name: 'Temporal Flux 5'},
      {id: 402601, name: 'All Creation 2'},
      {id: 402602, name: 'All Creation 3'},
      {id: 402603, name: 'All Creation 4'},
      {id: 402604, name: 'All Creation 5'},
      {id: 402701, name: 'Maelstrom 2'},
      {id: 402702, name: 'Maelstrom 3'},
      {id: 402703, name: 'Maelstrom 4'},
      {id: 402704, name: 'Maelstrom 5'},
      {id: 403001, name: 'Precognition 2'},
      {id: 403002, name: 'Precognition 3'},
      {id: 403003, name: 'Precognition 4'},
      {id: 403004, name: 'Precognition 5'},
      {id: 402801, name: 'Infinite Spiral 2'},
      {id: 402802, name: 'Infinite Spiral 3'},
      {id: 402803, name: 'Infinite Spiral 4'},
      {id: 402804, name: 'Infinite Spiral 5'},
      {id: 402901, name: 'Limited Wish 2'},
      {id: 402902, name: 'Limited Wish 3'},
      {id: 402903, name: 'Limited Wish 4'},
      {id: 402904, name: 'Limited Wish 5'},
    ];
