	...
	function PM_PRNG(state) {
		...
		// note that the normal range of initialized states is 0-2147483646
		// and the range of states the RNG can evolve to is 1-2147483646
		// the behavior of other initial states should be considered undefined
		this.state = state;

		this.gen = function () {
            if (this.state == 2147483647) return 2147483647;
