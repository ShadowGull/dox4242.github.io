		...
		var Format = new function() {
			...
			this.parseValue = function(format, position) {
                ...
                if (Number.isNaN(value)) {
                    alert("Invalid value detected for " + this.dataView + ". This value has been reset to 0.");
                    return 0;
                }
				return value;
			};
			...
			// The current Save Format (Up-to-date  game version 4.3.7.3, save format 58)
			{ this.format = [																				// Description
				...
				{ 'format': 'Uint16', 'key': 'idilliumExplorerCounter', 'cond': '_base/saveVersion >= 55' },// Counter for the Idillium Explorer feat
				{ 'format': 'Int32', 'key': 'cTimer' },														//
				{ 'format': 'Int32', 'key': 'kcTimer' },													//
				{ 'format': 'Int32', 'key': 'mTimer' },														//
				{ 'format': 'Float64', 'key': 'sTimer' },													//
				{ 'format': 'Float64', 'key': 'oTimer' },													// Production scry duration
				{ 'format': 'Float64', 'key': 'oTimer2' },													// Mana scry duration
				{ 'format': 'Float64', 'key': 'oTimer3', 'cond': '_base/saveVersion >= 13' },				// Event scry duration									//
				{ 'format': 'Float64', 'key': 'oTimer4', 'cond': '_base/saveVersion >= 58' },               // Tax Collection scry duration													//
				...
				{ 'format': 'Object', 'key': 'options', 		// The list of options
					...
					{ 'format': 'Int8', 'key': 'valentine_spell_icon' },
					{ 'format': 'Int8', 'key': 'easter_spell_icon' },
					{ 'format': 'Int8', 'key': 'blood_war_spell_icon' },
					{ 'format': 'Int8', 'key': 'goblin_invasion_spell_icon' },
					{ 'format': 'Int8', 'key': 'summer_spell_icon' },
					{ 'format': 'Int8', 'key': 'idillium_spell_icon' },
					{ 'format': 'Int8', 'key': 'halloween_spell_icon' },
					{ 'format': 'Int8', 'key': 'christmas_spell_icon' },
					{ 'format': 'Int8', 'key': 'no_offline' },
					{ 'format': 'Int8', 'key': 'no_toast_no_bread' },
					{ 'format': 'Int8', 'key': 'disable_faithful' },
					{ 'format': 'Int8', 'key': 'disable_myths' },
					{ 'format': 'Int8', 'key': 'mobile_longtap_tooltip' }
				] },
				{ 'format': 'Object', 'key': 'tutorials',
					...
					{ 'format': 'Int8', 'key': 'alignment_change' },    // 33
					{ 'format': 'Int8', 'key': 'autocast_unlocked' },    //34
					{ 'format': 'Int8', 'key': 'spell_tier_unlocked' },    //35
